...
public class KassapaateTest {
    ...
    @Test
    public void latausPositiivisellaSummallaOnnistuu() {
        kassa.lataa(kortti, 15);
        verify(kortti, times(1)).lataa(15);
    }

    @Test
    public void latausNegatiivisellaSummallaEiOnnistu() {
        kassa.lataa(kortti, -15);
        verify(kortti, times(0)).lataa(-15);
    }
